...
const EditTask = ({ modal, toggle, updateTask, taskObj }) => {
  ...
  // Add taskObj.Name and taskObj.Description as dependencies to avoid missing dependencies warning
  useEffect(() => {
    setTaskName(taskObj.Name);
    setDescription(taskObj.Description);
  }, [taskObj.Name, taskObj.Description]); // Add taskObj dependencies
